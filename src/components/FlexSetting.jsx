      ...
      <div className="m1 flex flex-column">
        ...
        <div className="col col-3">
          ...
          <div className="col col-9">
            <button className="h5 btn btn-outline maroon pmini mmini" name="direction" value="flex-row"
              disabled={this.props.cssValue.direction === 'row'}
              onClick={this.handleStyle.bind(this)}>row</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="direction" value="flex-column"
              disabled={this.props.cssValue.direction === 'column'}
              onClick={this.handleStyle.bind(this)}>column</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="direction" value="flex-rowr"
                disabled={this.props.cssValue.direction === 'row-reverse'}
                onClick={this.handleStyle.bind(this)}>row-reverse</button>
              <button className="h5 btn btn-outline maroon pmini mmini" name="direction" value="flex-columnr"
        ...
        <div className="border-bottom">
          ...
          <div className="col col-9">
            <button className="h5 btn btn-outline maroon pmini mmini" name="wrap" value="flex-nowrap"
              disabled={this.props.cssValue.wrap === 'nowrap'}
              onClick={this.handleStyle.bind(this)}>nowrap</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="wrap" value="flex-wrap"
              disabled={this.props.cssValue.wrap === 'wrap'}
              onClick={this.handleStyle.bind(this)}>wrap</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="wrap" value="flex-wrapr"
        ...
        <div className="border-bottom">
          ...
          <div className="col col-9">
            <button className="h5 btn btn-outline maroon pmini mmini" name="justify" value="flex-jstart"
              disabled={this.props.cssValue.justify === 'flex-start'}
              onClick={this.handleStyle.bind(this)}>flex-start</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="justify" value="flex-jend"
              disabled={this.props.cssValue.justify === 'flex-end'}
              onClick={this.handleStyle.bind(this)}>flex-end</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="justify" value="flex-jcenter"
              disabled={this.props.cssValue.justify === 'center'}
              onClick={this.handleStyle.bind(this)}>center</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="justify" value="flex-justify"
              disabled={this.props.cssValue.justify === 'space-between'}
              onClick={this.handleStyle.bind(this)}>space-between</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="justify" value="flex-jaround"
        ...
        <div className="border-bottom">
          ...
          <div className="col col-9">
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignItems" value="flex-stretch"
              disabled={this.props.cssValue.alignItems === 'stretch'}
              onClick={this.handleStyle.bind(this)}>stretch</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignItems" value="flex-start"
              disabled={this.props.cssValue.alignItems === 'flex-start'}
              onClick={this.handleStyle.bind(this)}>flex-start</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignItems" value="flex-end"
              disabled={this.props.cssValue.alignItems === 'flex-end'}
              onClick={this.handleStyle.bind(this)}>flex-end</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignItems" value="flex-center"
              disabled={this.props.cssValue.alignItems === 'center'}
              onClick={this.handleStyle.bind(this)}>center</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignItems" value="flex-baseline"
        ...
        <div>
          ...
          <div className="col col-9">
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignContent" value="flex-astretch"
              disabled={this.props.cssValue.alignContent === 'stretch'}
              onClick={this.handleStyle.bind(this)}>stretch</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignContent" value="flex-astart"
              disabled={this.props.cssValue.alignContent === 'flex-start'}
              onClick={this.handleStyle.bind(this)}>flex-start</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignContent" value="flex-aend"
              disabled={this.props.cssValue.alignContent === 'flex-end'}
              onClick={this.handleStyle.bind(this)}>flex-end</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignContent" value="flex-acenter"
              disabled={this.props.cssValue.alignContent === 'center'}
              onClick={this.handleStyle.bind(this)}>center</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignContent" value="flex-abetween"
              disabled={this.props.cssValue.alignContent === 'space-between'}
              onClick={this.handleStyle.bind(this)}>space-between</button>
            <button className="h5 btn btn-outline maroon pmini mmini" name="alignContent" value="flex-aaround"
